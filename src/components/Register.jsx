...
const Register = () => {
    ...
    return (
        ...
        <div className="flex h-screen overflow-hidden">
            ...
            */}}>
               <video src="https://res.cloudinary.com/doxalk3ms/video/upload/v1726400529/Preview_slide_show_shortened_hfs3cg.mp4" autoplay muted loop playsinline> You browser does not support the video tag. </video>
            </div>
