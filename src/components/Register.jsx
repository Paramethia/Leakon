...
const Register = () => {
    ...
    return (
        ...
        <div className="flex h-screen overflow-hidden">
            <div className="hidden md:block md:w-1/2 bg-auto" style={{ backgroundImage: 'url(https://res.cloudinary.com/doxalk3ms/image/upload/v1726273568/Infamous_sophie_rain_spider-man_vid_image_u5a059.png)' }}></div>
