...
const Register = () => {
    ...
    return (
        ...
        <div className="flex h-screen overflow-hidden">
            <div className="hidden md:block md:w-1/2 bg-auto bg-gray-400" style={{/* backgroundImage: 'url(https://res.cloudinary.com/doxalk3ms/image/upload/v1726273826/Infamous_sophie_rain_spider-man_vid_image_pdfyeb.png)', 
            ...
            */}}>
               <video src="https://res.cloudinary.com/doxalk3ms/video/upload/v1726318414/Preview_slide_show_shortened_nm2d1x.mov" autoplay muted loop className="w-full h-screen" alt="Registration videok"> You browser does not support the video tag. </video>
            </div>
