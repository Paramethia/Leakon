...
const Register = () => {
    ...
    return (
        ...
        <div className="flex h-screen overflow-hidden">
            <div className="hidden flex items-center md:block md:w-1/2 bg-auto bg-black" style={{/* backgroundImage: 'url(https://res.cloudinary.com/doxalk3ms/image/upload/v1726273826/Infamous_sophie_rain_spider-man_vid_image_pdfyeb.png)', 
