              ...
              <div className="flex pt-3 justify-center">
                {[1, 2, 3, 4, 5].map((tier) => (
                  ...
                  <a
                    ...
                    className="block text-center bg-[#282434] text-white font-bold py-2 px-4 rounded transition-colors hover:bg-[#3c3a4e]"
                  >
                ...
                {currentTier < 5 && (
                  <a href="block https://t.me/daemozon" className="text-center bg-[#282434] text-white font-bold py-2 px-4 rounded transition-colors hover:bg-[#3c3a4e] w-full">
